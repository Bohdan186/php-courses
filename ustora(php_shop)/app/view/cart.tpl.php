							...
							<table cellspacing="0" class="shop_table cart">
								...
								<tr class="cart_item">
									...
									<td class="product-thumbnail">
										<a href="?action=single-product"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="assets/img/product-thumb-2.jpg"></a>
									</td>
									
									<td class="product-name">
										<a href="?action=single-product">Ship Your Idea</a>
									</td>
							...
							<div class="cross-sells">
								...
								<ul class="products">
									<li class="product">
										...
										<a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="22" rel="nofollow" href="?action=single-product">Select options</a>
									</li>
