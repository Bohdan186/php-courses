						...
						<div class = "row no-gutters align-items-center">
							...
							<div class = "col-md-3">
								...
								<div class = "btn-wrapper">
									<a href = "?action=edit&edit-id=<?php
									echo $this_cafe['id']; ?>" name = "edit"
									   class = "btn btn-warning">Edit</a>
									<a href = "?action=remove-record&remove-id=<?php
									echo $this_cafe['id']; ?>"
									   name = "remove-record" class = "btn btn-danger">Remove</a>
								</div>
							</div>
						</div>
					</div>
