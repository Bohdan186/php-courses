		...
		<div class="row product-main-page-inner">
			<div class="col-md-12 col-lg-8">
				<div class="swiper-container gallery-top btn-wrapper" >
					<div class="swiper-wrapper photo-swipe">
						<div class="swiper-slide"><a href="<?php echo lb_esc_html( $data['this_product']['img_url'] ); ?>" data-width="890" data-height="1080"><img src="<?php echo lb_esc_html( $data['this_product']['img_url'] ); ?>" alt="<?php echo lb_esc_html( $data['this_product']['name'] ); ?>"></a></div>
					</div>
				</div>
			</div>
			<div class="col-md-12 col-lg-4">
				<div class="product-page-text product-sticky">
					<h3>
						<?php echo lb_esc_html( $data['this_product']['name'] ); ?>
					</h3>
					<div class="price">
						<?php echo lb_esc_html( $data['this_product']['price'] ); ?>
					</div>
					<p>
						<?php echo lb_esc_html( $data['this_product']['short_description'] ); ?>
					</p>
					...
					<div class="row sku-category">
						...
						<div class="col-9">
							<span class="info">
								<?php echo lb_esc_html( $data['this_product']['SKU'] ); ?>
							</span>
						</div>
					...
					<div class="description">
						<h4>Description</h4>
						<p>
							<?php echo lb_esc_html( $data['this_product']['description'] ); ?>
						</p>
					</div>
				</div>
			</div>
