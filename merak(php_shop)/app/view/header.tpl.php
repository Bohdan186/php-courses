		...
		<div class="container">
			<div class="header-row color-schema-white">
				...
				<div class="header-col-right">
					...
					<div class="languare"> <img src="assets/img/usa-icon.svg" alt=""> USA <i class="fas fa-angle-down"></i></div>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="header-row">
				<div class="header-col-left">
					<ul class="menu-categories">
						<li class="<?php echo $_GET['action=home'] ? 'active-dropdown' : '' ?>"><a href="#" class="categories-main color-schema-white"><span><i class="fas fa-bars"></i> Browse Categories</span> <i class="fas fa-angle-down"></i></a>
							<ul class="menu-dropdown menu-categories">
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-1.svg" alt="">Sweatshirts</span> <i class="fas fa-angle-right"></i></a>
									<div class="menu-dropdown large-dropdown sweatshirts">
										<div class="row">
											<div class="col-5">
												<div class="dropdown-title">
													<img src="assets/img/category-svg/merak-category-icon-1.svg" alt="">
													<h5>Sweaters</h5>
												</div>
												<ul>
											...
											<div class="col-2">
												<div class="dropdown-category-img">
													<img src="assets/img/megamenues/merak-megamenu-category-girl.png" alt="">
												</div>
											</div>
										</div>
									</div>
								</li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-2.svg" alt="">Dresses</span> <i class="fas fa-angle-right"></i></a>
									<div class="menu-dropdown large-dropdown dresses">
										<div class="row">
											<div class="col-4">
												<div class="dropdown-title-img">
													<img src="assets/img/megamenues/merak-megamenu-category-banner-1.jpg" alt="">
											...
											<div class="col-4">
												<div class="dropdown-title-img">
													<img src="assets/img/megamenues/merak-megamenu-category-banner-2.jpg" alt="">
													<div class="dropdown-title-img-inner">
														<h5>Mid dresses</h5>
													</div>
												</div>
											...
											<div class="col-4">
												<div class="dropdown-title-img">
													<img src="assets/img/megamenues/merak-megamenu-category-banner-3.jpg" alt="">
													<div class="dropdown-title-img-inner">
														<h5>Mini dresses</h5>
													</div>
												</div>
										...
										<div class="dresses-menu-link">
											<a href="#"><img src="assets/img/brands-ready/merak-brand-1.png" alt=""></a>
											<a href="#"><img src="assets/img/brands-ready/merak-brand-2.png" alt=""></a>
											<a href="#"><img src="assets/img/brands-ready/merak-brand-3.png" alt=""></a>
											<a href="#"><img src="assets/img/brands-ready/merak-brand-4.png" alt=""></a>
											<a href="#"><img src="assets/img/brands-ready/merak-brand-5.png" alt=""></a>
											<a href="#"><img src="assets/img/brands-ready/merak-brand-6.png" alt=""></a>
										</div>
									</div>
								</li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-3.svg" alt="">Jackets</span> <i class="fas fa-angle-right"></i></a>
												...
												<div class="popular-products">
													...
													<div class="row">
														<div class="col-6">
															<div class="product-box">
																<div class="product-foto">
																	<img src="assets/img/products(compressed)/merak-product-29-min.jpg" alt="">
																	<div class="product-foto-hover">
																		<img src="assets/img/products(compressed)/merak-product-29-2-min.jpg" alt="">
														...
														<div class="col-6">
															<div class="product-box">
																<div class="product-foto">
																	<img src="assets/img/products(compressed)/merak-product-32-2-min.jpg" alt="">
																	<div class="product-foto-hover">
																		<img src="assets/img/products(compressed)/merak-product-32-min.jpg" alt="">
																		<a href="#" class="link-full"></a>
																		<div class="button-product-wrapper">
																			<a href="#" class="button button-product"><i class="fas fa-plus"></i></a>
																			<a href=".quick-view" class="button button-product btn-popup" data-effect="mfp-move-horizontal" data-toggle="tooltip" data-placement="top" title="Search"><i class="fas fa-search"></i></a>
								...
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-4.svg" alt="">Pants</span> <i class="fas fa-angle-right"></i></a>
									<div class="menu-dropdown large-dropdown pants">
										<div class="row">
											...
											<div class="col-4 menu-border-left">
												<img src="assets/img/megamenues/merak-megamenu-category-banner-4.jpg" alt="">
								...
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-5.svg" alt="">Cardigan</span></a></li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-6.svg" alt="">Boots</span></a></li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-7.svg" alt="">Loafers</span></a></li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-8.svg" alt="">Handbags</span></a></li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-9.svg" alt="">Hats</span></a></li>
								<li><a href="#"><span><img src="assets/img/category-svg/merak-category-icon-10.svg" alt="">Accessories</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
				<div class="header-col-center">
					<ul class="menu-main">
						<li><a href="?action=home"><span class="menu-border active"> Home </span><i class="fas fa-angle-down"></i></a>
							<div class="menu-dropdown large-dropdown home">
								<div class="row">
									<div class="col-4">
										<h5>Home #1</h5>
										<p>Women's urban clothing store</p>
										<a href="?action=home"><img src="assets/img/megamenues/merak-megamenu-home-1.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<h5>Home #2</h5>
										<p>Women's urban clothing store</p>
										<a href="#"><img src="assets/img/megamenues/merak-megamenu-home-2.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<h5>Home #3</h5>
										<p>Women's urban clothing store</p>
										<a href="#"><img src="assets/img/megamenues/merak-megamenu-home-3.jpg" alt=""></a>
									</div>
								</div>
							</div>
						</li>
						<li><a href="?action=shop"><span class="menu-border">Shop</span> <i class="fas fa-angle-down"></i></a>
								...
								<div class="row menu-dropdown-inner">
									...
									<div class="col-3">
										<div class="shop-dropdown-img">
											<img src="assets/img/megamenues/merak-megamenu-banner-1.jpg" alt="">
									...
									<div class="col-6">
										...
										<div class="popular-categories">
											<a href="#"><img src="assets/img/home-2-category/merak-home-2-category-5.jpg" alt=""></a>
											<a href="#"><img src="assets/img/home-2-category/merak-home-2-category-7.jpg" alt=""></a>
											<a href="#"><img src="assets/img/home-2-category/merak-home-2-category-2.jpg" alt=""></a>
											<a href="#"><img src="assets/img/home-2-category/merak-home-2-category-9.jpg" alt=""></a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="menu-dropdown large-dropdown blog">
								...
								<div class="rectangle color-schema-white">
									...
									<div class="rectangle-video">
										<img src="assets/img/megamenues/merak-megamenu-video.jpg" alt="">
