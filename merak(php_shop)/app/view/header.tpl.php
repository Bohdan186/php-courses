...
$products_in_cart = lb_get_product_data_for_cart( lb_get_products_id_from_session() );
?>
								...
								<div class="cart-product">
									<div class="product_wrapper">
										<div class="product-img">
											<img src="<?php echo lb_esc_html( $product_in_cart['img_url'] ); ?>" alt="<?php echo lb_esc_html( $product_in_cart['name'] ); ?>">
										</div>
										<div class="product-body">
											<div class="product-name">
												<?php echo lb_esc_html( $product_in_cart['name'] ); ?>
											</div>
											<div class="product-price">
												price for one:
												<strong>
													<?php echo lb_esc_html( $product_in_cart['price'] ); ?> $
												</strong>
											</div>
									...
									<a href="?action=<?php echo lb_esc_html( $_GET['action'] ); ?>&delete_from_cart=<?php echo lb_esc_html( $product_in_cart['id']  )?>" class="product-delete">
